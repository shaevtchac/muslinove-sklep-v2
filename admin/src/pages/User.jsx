      ...
      <UserContainer>
        <Show>
          <Top>
            ...
            />
            <UserHeader>
              <UserName>Anna Pobłażliwa</UserName>
          ...
          <Bottom>
            ...
            <InfoWrapper>
              ...
              <DetailInfo>506 696 696</DetailInfo>
            </InfoWrapper>
            <InfoWrapper>
              <EmailOutlined fontSize="small" />
              <DetailInfo>Anna6969@gmail.com</DetailInfo>
            </InfoWrapper>
            <InfoWrapper>
              <LocationSearching fontSize="small" />
              <DetailInfo>Drążdżewo | Poland</DetailInfo>
            </InfoWrapper>
          </Bottom>
        </Show>
        <Update>
          ...
          <Form>
            <FormLeft>
              <UserUpdateItem>
                ...
                <Input type="text" placeholder="Anna6969" />
              </UserUpdateItem>
              <UserUpdateItem>
                <Label>Imię i nazwisko:</Label>
                <Input type="text" placeholder="Anna Pobłażliwa" />
              </UserUpdateItem>
              <UserUpdateItem>
              ...
              <UserUpdateItem>
                ...
                <Input type="text" placeholder="506 696 696" />
              </UserUpdateItem>
              <UserUpdateItem>
                <Label>Adres e-mail:</Label>
                <Input type="text" placeholder="Anna6969@gmail.com" />
              </UserUpdateItem>
              <UserUpdateItem>
                <Label>Adres:</Label>
                <Input type="text" placeholder="Drążdżewo | Poland" />
              </UserUpdateItem>
            </FormLeft>
            <FormRight>
              <ImgUpload>
